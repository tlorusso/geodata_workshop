...
Dataframes with class 'sf' are ordinary dataframes with a special column containing the geo-variable. It can be handeld like any ordinary structured dataframe.
