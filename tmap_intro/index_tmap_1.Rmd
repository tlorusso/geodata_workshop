...
# select S_ID,	S_J_ERHJAHR,	BFS_AKT,	parznr, N_PREIS, CENTROID_X,	CENTROID_Y from HA_PROD.HA_HAUPTTAB_AS_MV a
# join (select BFSNR, NUMMER, SHAPE_AREA, CENTROID_X, CENTROID_Y  from GEO.LIEGEN_GESAMT_TEMP_MV) d
# on a.BFS_AKT = d.BFSNR AND a.parznr=d.nummer
