...
It builds upon 'simple features', a standard which is not R specific: https://en.wikipedia.org/wiki/Simple_Features
...
```{r,echo=TRUE,message = TRUE,warnings=F,cache=F}
